# IMPORTANT: All Code is in Courtesy of: CalvinLocke (https://github.com/CalvinLoke/bad-apple)
# I just made it output in a tkinter window instead of the console.
...
def play_video(total_frames):
    ...
    for frame_number in range(start_frame, total_frames):
        ...
        text_widget.insert(tk.END, ASCII_LIST[frame_number])
        root.update()
        timer.sleep()
